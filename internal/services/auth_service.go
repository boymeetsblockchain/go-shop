...
import (
	...
	"github.com/boymeetsblockchain/e-commerce/internal/dto"
	"github.com/boymeetsblockchain/e-commerce/internal/models"
	"github.com/boymeetsblockchain/e-commerce/utils"
	"gorm.io/gorm"
)
...
func (s *AuthService) generateAuthResponse(user *models.User) (*dto.AuthResponse, error) {
	accessToken, refreshToken, err := utils.GenerateJWT(
		&s.config.JWT,
		user.ID,
		user.Email,
		string(user.Role),
